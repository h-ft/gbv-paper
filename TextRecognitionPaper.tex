...
This paper begins by observing the interference found on natural scenesm followed by introducing and giving an overview of CRAFT and EAST.
It then presents an overview on the how text is detected using both CRAFT and EAST, along with an explanation of the evaluation dataset. Subsequently, the performance review of the algorithm will be presented, which is obtained by testing the preferred method on the aforementioned dataset.
