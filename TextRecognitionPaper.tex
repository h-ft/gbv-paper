...
It then presents an overview on the how text is detected using CRAFT (or EAST, to be edited). Subsequently, the performance review of the algorithm will be presented, which is obtained by testing the preferred method on both structured and unstructured text.
