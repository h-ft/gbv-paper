...
\label{sub:easy}
The following is the best-detected image from the easy group:
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=0.5\textwidth]{jupyter/results/easy/sample_output_3.jpeg}
	\caption{The best-detected image from the 'easy' group.}
	\label{fig:sampleeasybest}
\end{figure}
% subsection easy (end)
