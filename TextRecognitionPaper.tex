...
\label{sub:testing}
The test will be done on three different data groups with varying degrees of difficulties. They will be divided into easy, medium, and hard. The aim of this test is to see which method performs better on detecting text in natural scene images, determined by which network has the most detection rate and speed.
