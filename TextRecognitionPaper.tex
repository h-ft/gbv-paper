...
\label{sub:easy}
The easy group was done in approximately 2.83 seconds. In the detection process, every image is resized to a square of 640 pixels. In the final step, the boxes are drawn on top of the original image. The following are the best and worst detected image respectively:
\begin{figure}[h!]
	\centering
	\begin{subfigure}[b]{0.4\linewidth}
...
\label{sub:inter}
The intermediate group was done in approximately 2.68 seconds. In the detection process, every image is resized to a square of 640 pixels. In the final step, the boxes are drawn on top of the original image. The following are the best and worst detected image respectively:
\begin{figure}[h!]
	\centering
	\begin{subfigure}[b]{0.4\linewidth}
...
\label{sub:hard}
The hard group was done in approximately 2.57 seconds. In the detection process, every image is resized to a square of 640 pixels. In the final step, the boxes are drawn on top of the original image. The following are the best and worst detected image respectively:
\begin{figure}[h!]
	\centering
	\begin{subfigure}[b]{0.4\linewidth}
